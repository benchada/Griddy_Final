...
public class BOINCActivity extends ActionBarActivity
    ...
    private SlidingTabsBasicFragment slidingTabsBasicFragment;
  //  private SlidingTabsBasicFragment.LeaderBoard leaderboard = new SlidingTabsBasicFragment.LeaderBoard();
...
//=-------------------------------------------------------------------------------------
        ...
        transaction.replace(R.id.test_container, slidingTabsBasicFragment);
        transaction.commit();
...
/*
                    tasksFragment.show(getFragmentManager(),"n");
*/
...
*/
                    ...
                    noticesFragment.show(getFragmentManager(),"n1");
                    fragmentChanges = true;
                    break;
...
*/
                    ...
                    projectsFragment.show(getFragmentManager(),"n");
                    fragmentChanges = true;
                    break;
...
*/
                    ...
                    prefsFragment.show(getFragmentManager(),"n");
...
/*    public class ProfileFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View projects = inflater.inflate(R.layout.profile_frag, container, false);
    ...
    public void onConnected(Bundle bundle) {
       // Player p = Games.Players.getCurrentPlayer(mGoogleApiClient);
        ...
        if (Plus.PeopleApi.getCurrentPerson(mGoogleApiClient) != null) {
            ...
            bundle1.putString("name", personName);
            bundle1.putString("photoUrl",personPhotoUrl);


// set Fragmentclass Arguments
            SlidingTabsBasicFragment fragobj = new SlidingTabsBasicFragment();
...
public class BOINCActivity extends ActionBarActivity implements
...
*//*
    ...
    public String personGooglePlusProfile;
    ...
    public void onConnected(Bundle bundle) {
        if (Plus.PeopleApi.getCurrentPerson(mGoogleApiClient) != null) {
            ...
            new LoadProfileImage(imgProfilePic).execute(personPhoto);
    ...
    public class ProfileFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            ((TextView)ProfileFragment.findViewById(R.id.User_Name)).setText("UserName");
            imgProfilePic = (ImageView) findViewById(R.id.profile_image);
            WelcomeMsg = (TextView) findViewById(R.id.textView);
            WelcomeMsg.setText("Welcome To Griddy,  "+personName);
